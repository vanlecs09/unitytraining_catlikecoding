...
float3 GetEmission(Interpolators i)
{
    ...
    return tex2D(_EmissionMap, i.uv.xy).rbg * _Emission;
    #else
    return _Emission;
    #endif
    #else
...
{
    float smoothness = 1;
    #if defined(_SMOOTHNESS_UNIFORM)
    smoothness = 1;
    #elif defined(_SMOOTHNESS_ALBEDO)
...
float GetOcclusion(Interpolators i)
{
    ...
    return lerp(1, tex2D(_OcclusionMap, i.uv.xy).r, _OcclusionStrength);
    #else
    return 1;
    #endif
}
