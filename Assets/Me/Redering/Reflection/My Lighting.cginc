...
//             boxMin -= position;
//             boxMax -= position;
//             float x = (direction.x < 0 ? boxMin.x : boxMax.x ) / direction.x;
//             float y = (direction.y < 0 ? boxMin.y : boxMax.y ) / direction.y;
//             float z = (direction.z < 0 ? boxMin.z : boxMax.z ) / direction.z;
//             float scalar = min(x, min(y,z));

//             return direction * scalar + (position - cubemapPosition.xyz);
//         }
//         return direction;
//     #endif
//     return direction;
...
UnityIndirect CreateIndirectLight (Interpolators i, float3 viewDir) {
	...
	indirectLight.specular = 0;
        ...
        // indirectLight.specular = float3(1.0, 0, 0);
