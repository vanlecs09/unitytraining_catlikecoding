...
public class CubeSphere : MonoBehaviour
{
    ...
    private void CreateVertices()
    {
        ...
        for (int y = 0; y <= gridSize; y++)
        {
            ...
            {
                // vertices[v++] = new Vector3(gridSize, y, z);
                SetVertex(v++, gridSize, y, z);
            }

            for (int x = gridSize - 1; x >= 0; x--)
            {
                // vertices[v++] = new Vector3(x, y, gridSize); ;
    ...
    private void SetVertex(int i, int x, int y, int z)
    {
        ...
        v.x = v.x * Mathf.Sqrt(1 - v.y * v.y / 2 - v.z * v.z / 2 + v.y * v.y * v.z * v.z / 3);
        v.y = v.y * Mathf.Sqrt(1 - v.x * v.x / 2 - v.z * v.z / 2 + v.x * v.x * v.z * v.z / 3);
        v.z = v.z * Mathf.Sqrt(1 - v.y * v.y / 2 - v.x * v.x / 2 + v.y * v.y * v.x * v.x / 3);
    ...
    private void CreateTriangles()
    {
        ...
        // int[] triangles = new int[quads * 2 * 3];
